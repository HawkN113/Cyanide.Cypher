    ...
    INode<CreateClause>
{
    ...
    /// <summary>
    /// Add a basic relationship to the CREATE clause
    /// </summary>
    /// <param name="left"></param>
    /// <param name="right"></param>
    /// <param name="relation"></param>
    /// <returns></returns>
    public CreateClause WithRelation(Entity left, Entity right, BasicRelationshipType relation = BasicRelationshipType.RelatedTo)
    {
