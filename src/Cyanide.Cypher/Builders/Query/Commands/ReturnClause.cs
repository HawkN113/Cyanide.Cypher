...
public sealed class ReturnClause(StringBuilder returnClauses) : IBaseQuery, IClause, IFieldProperty<ReturnClause>,
    IFieldAlias<ReturnClause>, IFieldType<ReturnClause>
{
